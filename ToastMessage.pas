...
begin
  ...
  begin
     ...
     raise Exception.Create('Desculpe, n�o foi poss�vel exibir a notifica��o pois n�o existe nenhum formul�rio acess�vel no momento.');
end;
...
{-- EXEMPLO DE USO:
  ...
  begin
    TToastMessage.show('Esta é uma mensagem superior.');
  end;
--}
